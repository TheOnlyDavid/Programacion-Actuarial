...
## Caso 3
### Hérnandez Resendiz Guillermo
### Montero Zapata Judy Esperanza
### Moreno Téllez Melissa
### Ramírez Olmeda David Aarón

####Introducción
Los datos analizados en este caso son recabados de los acelerómetros de
celulares Samsung Galaxy, pero vienen en diferentes archivos de texto, la misión
...
también juntamos los sujetos de prueba y leemos "feature.txt" para usarlos
despues.
...
####Parte 2
Tenemos que usar únicamente los datos de media y desviación estandar de los
datos. Primero tenemos que ponerle los nombres a las columnas de los datos,
de otra forma sería dificil hacerlo después.
...
####Parte 4
En este paso ya está hecho, pero se pueden escribir los nombres de las columnas
de una forma más amena, luego juntamos los datos para formar la tabla de datos
final.
